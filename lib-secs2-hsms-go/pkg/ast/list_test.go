...
func TestListNode_ProducedByFactoryMethod1(t *testing.T) {
	listNode := NewListNode([]interface{}{
		NewListNode(NewListNode([]interface{}{
			NewListNode(NewIntNode(2, 30, 50)),
			NewListNode(NewIntNode(2, 30, 51)),
			NewListNode(NewIntNode(2, 30, 52)),
			NewListNode(NewIntNode(2, 30, 53)),
		}...)),
		NewListNode(NewIntNode(2, 31, 55)),
		NewListNode(NewIntNode(2, 32, 55)),
		NewListNode(NewIntNode(2, 33, 55)),
		NewListNode(NewIntNode(2, 34, 55)),
		NewListNode(),
	}...)
	fmt.Println("listNode : ", listNode)

	node, err := listNode.Get(1, 0)
	fmt.Println()
	fmt.Println()
